class ScoreSubjectAverage
  ...
  attr_accessor :title, :jpn_ctp, :jpn_classic, :jpn_chinese, :jpn,
                ...
                :listening, :reading, :english, :language, :user_id, :average_id, :subject_id,
  ...
  def save
    ...
    Score.create(title: title, jpn_ctp: jpn_ctp, jpn_classic: jpn_classic, jpn_chinese: jpn_chinese, jpn: jpn,
      ...
      listening: listening, reading: reading, english: english, language: language, user_id: user_id, average_id: average.id, subject_id: subject.id)
